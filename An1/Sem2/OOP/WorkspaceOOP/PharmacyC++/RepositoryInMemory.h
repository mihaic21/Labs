...
#ifndef __PharmacyC____RepositoryInMemory__
#define __PharmacyC____RepositoryInMemory__
...
class RepositoryInMemory:public RepositoryAbstract{
private:
    /*
...
#endif /* defined(__PharmacyC____RepositoryInMemory__) */
