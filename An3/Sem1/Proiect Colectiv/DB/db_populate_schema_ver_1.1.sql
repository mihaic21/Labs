...
insert into owners (first_name, last_name, address,  deleted) values ('Célestine', 'Davis', 'Paungde, Myanmar, Carioca, 5954, 4450, 73, 55, 0', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Néhémie', 'Young', 'Tío Pujio, Argentina, Springview, 716, 35130, 78, 34, 1', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Célestine', 'Oliver', 'Tougan, Burkina Faso, Monument, 8356, 3540, 40, 90, 1', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Annotés', 'Perkins', 'Espinosa, Brazil, Bowman, 7041, 5, 42, 71, 0', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Lài', 'Adams', 'Pidvynohradiv, Ukraine, Orin, 655, 36, 76, 35, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Tán', 'Carpenter', 'Baturaden, Indonesia, Coleman, 8929, 123, 29, 34, 1', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Gaétane', 'Watson', 'Pont Cassé, Dominica, Banding, 7468, 7, 15, 31, 0', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Maëlyss', 'Martin','Shenzhong, China, Schlimgen, 1786, 3, 68, 100, 1', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Angélique', 'Armstrong', 'Pakuncen, Indonesia, Dexter, 1805, 04557, 67, 36, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Irène', 'Sims', 'Taoyuan, China, Dennis, 8923, 793, 83, 88, 1', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Léane', 'Allen', 'Al Jahra, Kuwait, Declaration, 1993, 5109, 86, 5, 1', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Zhì', 'Day', 'Gizalki, Poland, Comanche, 1220, 445, 13, 23, 0', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Aloïs', 'Bailey', 'Gizalki, Poland, Comanche, 1220, 445, 13, 23, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Cléopatre', 'Ross', 'Roche-à-Bateau, Haiti, Esch, 3714, 8, 71, 54, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Kévina', 'Snyder', 'Pakisrejo, Indonesia, Jay, 6107, 37, 81, 73, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Nélie', 'Ford', 'Kongsvinger, Norway, Buell, 6582, 84, 75, 98, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Léone', 'Clark', 'Ryazan, Russia, Toban, 3159, 96329, 38, 88, 0', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Inès', 'Allen', 'Caruaru, Brazil, Shoshone, 8271, 8081, 35, 36, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Naëlle', 'Wilson', 'Trabulheira, Portugal, High Crossing, 3465, 67, 7, 24, 1', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Geneviève', 'Alexander', 'Boa Viagem, Brazil, Fair Oaks, 8010, 2121, 24, 34, 1', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Mélissandre', 'Duncan', 'Qinxi, China, Starling, 4660, 402, 100, 67, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Mà', 'Kim', 'Ozerki, Russia, Parkside, 2580, 5212, 91, 38, 0', 0);
insert into owners (first_name, last_name, address,  deleted) values ('Maïwenn', 'Spencer', 'Mosteirô, Portugal, Carberry, 1383, 1948, 19, 63, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Mà', 'Morales', 'El Tabo, Chile, Towne, 5171, 1, 62, 100, 0', 1);
insert into owners (first_name, last_name, address,  deleted) values ('Marlène', 'Gibson', 'Kanash, Russia, Memorial, 2332, 180, 34, 8, 1', 0);
...
insert into users (username, password, `admin`) values ('cjames0', '0a0EyLk',0);
insert into users (username, password, `admin`) values ('egraham1', 'qxW3Ngrr9Aog',0);
insert into users (username, password, `admin`) values ('aandrews2', 'fDaMdY3QR',0);
insert into users (username, password, `admin`) values ('schavez3', 'XwcGUJiwLVoU',0);
insert into users (username, password, `admin`) values ('aromero4', 'YiofAupH9',0);
insert into users (username, password, `admin`) values ('ptaylor5', 'ur3yKtTAB',0);
insert into users (username, password, `admin`) values ('klane6', 'F1LjN667JEg',0);
insert into users (username, password, `admin`) values ('jperry7', '6WzlJ4aI',0);
insert into users (username, password, `admin`) values ('rwagner8', '0gjiiFIOBE',0);
insert into users (username, password, `admin`) values ('pmorales9', 'jDbYGZxQzOWC',0);
insert into users (username, password, `admin`) values ('drobinsona', 'DuOE4RXqRO',0);
insert into users (username, password, `admin`) values ('dwoodb', '1kOO2Ak0L',0);
insert into users (username, password, `admin`) values ('rsnyderc', 'kEXQfi',0);
insert into users (username, password, `admin`) values ('dbelld', 'BJMZaZx',0);
insert into users (username, password, `admin`) values ('cwagnere', 'F6Aor9Lg81',0);
insert into users (username, password, `admin`) values ('afullerf', 'OOME9t2av',0);
insert into users (username, password, `admin`) values ('mburnsg', 'YDyG2wF0Qzif',0);
insert into users (username, password, `admin`) values ('fchapmanh', 'EEyqSlx95',0);
insert into users (username, password, `admin`) values ('lrobertsoni', 'Gd7Q0dk',0);
insert into users (username, password, `admin`) values ('jfrazierj', 'aswqxS',0);
insert into users (username, password, `admin`) values ('rjacobsk', '6SYctwX',0);
insert into users (username, password, `admin`) values ('smedinal', 'eMSAh6w',0);
insert into users (username, password, `admin`) values ('rharveym', 'R1v3LqtnRd',0);
insert into users (username, password, `admin`) values ('rsnydern', '9Lv8wpY3',0);
insert into users (username, password, `admin`) values ('q', '7694f4a66316e53c8cdd9d9954bd611d',1);
insert into users (username, password, `admin`) values ('root', '63a9f0ea7bb98050796b649e85481845',1);

------------------------------------------------------------------------------------------

truncate table transactions;

insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (1, '2014-09-19', 580, 'Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est. Phasellus sit amet erat.', '6, 5677, \'2014-06-11\', \'2014-01-19\', 1', '7, 5677, \'2014-06-11\', \'2014-01-19\', 1', 'receipts');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (2, '2014-01-17', 2838, 'Vivamus vel nulla eget eros elementum pellentesque.', '6, 5677, \'2014-06-11\', \'2014-01-19\', 1', '7, 5677, \'2014-06-11\', \'2014-01-19\', 1', 'receipts');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (3, '2014-02-18', 1339, 'Mauris sit amet eros.', '6, 5677, \'2014-06-11\', \'2014-01-19\', 1', '7, 5677, \'2014-06-11\', \'2014-01-19\', 1', 'receipts');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (4, '2014-10-04', 4026, 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem. Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat.', '6, 5677, \'2014-06-11\', \'2014-01-19\', 1', '7, 5677, \'2014-06-11\', \'2014-01-19\', 1', 'receipts');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (5, '2014-10-15', 1599, 'Nulla tellus. In sagittis dui vel nisl. Duis ac nibh.', '6, 5677, \'2014-06-11\', \'2014-01-19\', 1', '7, 5677, \'2014-06-11\', \'2014-01-19\', 1', 'receipts');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (6, '2014-05-23', 5981, 'Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.', '6, 5677, \'2014-06-11\', \'2014-01-19\', 1', '7, 5677, \'2014-06-11\', \'2014-01-19\', 1', 'receipts');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (7, '2014-06-29', 701, 'Praesent lectus. Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis. Duis consequat dui nec nisi volutpat eleifend.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (8, '2014-11-09', 745, 'Donec vitae nisi. Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus. Curabitur at ipsum ac tellus semper interdum.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (9, '2013-12-30', 6942, 'Etiam vel augue.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (10, '2014-03-03', 400, 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus. In sagittis dui vel nisl.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (11, '2014-03-19', 1951, 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet. Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (12, '2014-06-06', 7171, 'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque. Duis bibendum.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (13, '2014-11-04', 7031, 'Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam. Nam tristique tortor eu pede.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (14, '2014-07-19', 2606, 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (15, '2014-05-08', 267, 'Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus. Pellentesque at nulla.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (16, '2014-03-03', 5245, 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros. Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (17, '2014-04-26', 3326, 'Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est. Phasellus sit amet erat.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (18, '2014-07-16', 7430, 'Integer ac neque. Duis bibendum.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (19, '2013-12-01', 4032, 'Integer ac neque. Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (1, '2014-03-04', 5055, 'Sed ante. Vivamus tortor.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (2, '2014-10-21', 1550, 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (3, '2014-10-31', 4639, 'Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede. Morbi porttitor lorem id ligula.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (4, '2014-06-25', 3364, 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat. Curabitur gravida nisi at nibh.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (5, '2014-04-30', 2504, 'Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus. Suspendisse potenti.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
insert into transactions (user_id, timestamp, document_number, modification_details, `before`, `after`, `table`) values (6, '2014-08-10', 535, 'Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis. Fusce posuere felis sed lacus.', '\'wbrookso\', \'nx0S0bDlA\'', '\'wbrookso\', \'nx0S0lA\'', 'users');
